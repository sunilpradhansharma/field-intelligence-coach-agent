...
class ScopeError(Exception):
    """Raised when a caller requests data outside their territory.

    Enforcement is implemented in the RBAC task (T008); defined here so the contract
    is stable for all implementations.
    """
...
class AccessContext:
    ...
    read_only: bool = False  # True for an RBD
